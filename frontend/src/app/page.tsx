...
const BUILT: BentoItem[] = [
    ...
    },
    {
        ...
        status: 'DevOps',
        description:
            'GitHub Actions runs 367 tests, builds and smoke-tests a Docker image, and publishes it. An EC2 server pulls it at boot behind nginx with Let\u2019s Encrypt HTTPS; the frontend ships on Vercel.',
